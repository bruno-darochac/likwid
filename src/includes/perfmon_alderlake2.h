 ...
 * =======================================================================================
 *
 *      Filename:  perfmon_alderlake2.h
 *
 *      Description:  Header File of perfmon module for Intel alderlake2.
 *
 *      Version:   <VERSION>
 *      Released:  <DATE>
 *
...
#include <perfmon_alderlake2_events.h>
#include <perfmon_alderlake2_counters.h>

static int perfmon_numCountersAlderLake2 = NUM_COUNTERS_ALDERLAKE2;
static int perfmon_numCoreCountersAlderLake2 = NUM_COUNTERS_CORE_ALDERLAKE2;
static int perfmon_numUncoreCountersAlderLake2 = NUM_COUNTERS_UNCORE_ALDERLAKE2;
static int perfmon_numArchEventsAlderLake2 = NUM_ARCH_EVENTS_ALDERLAKE2;

int perfmon_init_alderlake2(int cpu_id)
{
    int ret = 0;
...
uint32_t adl2_fixed_setup(int cpu_id, RegisterIndex index, PerfmonEvent *event)
{
    (void)cpu_id;
...
int adl2_pmc_setup(int cpu_id, RegisterIndex index, PerfmonEvent *event)
{
...
int perfmon_setupCounterThread_alderlake2(
        int thread_id,
        PerfmonEventSet* eventSet)
{
    ...
    for (int i=0;i < eventSet->numberOfEvents;i++)
    {
        ...
        {
            case PMC:
                adl2_pmc_setup(cpu_id, index, event);
                break;

            case FIXED:
                fixed_flags |= adl2_fixed_setup(cpu_id, index, event);
                break;
...
int perfmon_startCountersThread_alderlake2(int thread_id, PerfmonEventSet* eventSet)
{
    int haveLock = 0;
    uint64_t flags = 0x0ULL;
...
int perfmon_stopCountersThread_alderlake2(int thread_id, PerfmonEventSet* eventSet)
{
    int haveLock = 0;
...
int perfmon_readCountersThread_alderlake2(int thread_id, PerfmonEventSet* eventSet)
{
    uint64_t flags = 0x0ULL;
    uint64_t uflags = 0x0ULL;
    int haveLock = 0;
...
int perfmon_finalizeCountersThread_alderlake2(int thread_id, PerfmonEventSet* eventSet)
{
    int haveLock = 0;
    int clearPBS = 0;
