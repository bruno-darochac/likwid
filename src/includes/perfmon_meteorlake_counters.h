...
static RegisterMap meteorlake_counter_map[NUM_COUNTERS_METEORLAKE] = {
    ...
    {"PMC0",  PMC3,  PMC,    MSR_PERFEVTSEL0, MSR_PMC0, 0, 0, TGL_VALID_OPTIONS_PMC},
    {"PMC1",  PMC4,  PMC,    MSR_PERFEVTSEL1, MSR_PMC1, 0, 0, TGL_VALID_OPTIONS_PMC},
    {"PMC2",  PMC5,  PMC,    MSR_PERFEVTSEL2, MSR_PMC2, 0, 0, TGL_VALID_OPTIONS_PMC | EVENT_OPTION_IN_TRANS_ABORT_MASK},
    {"PMC3",  PMC6,  PMC,    MSR_PERFEVTSEL3, MSR_PMC3, 0, 0, TGL_VALID_OPTIONS_PMC},
    {"PMC4",  PMC7,  PMC,    MSR_PERFEVTSEL4, MSR_PMC4, 0, 0, TGL_VALID_OPTIONS_PMC},
    {"PMC5",  PMC8,  PMC,    MSR_PERFEVTSEL5, MSR_PMC5, 0, 0, TGL_VALID_OPTIONS_PMC},
