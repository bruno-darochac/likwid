 ...
 * =======================================================================================
 *
 *      Filename:  perfmon_alderlake1.h
 *
 *      Description:  Header File of perfmon module for Intel alderlake1.
 *
 *      Version:   <VERSION>
 *      Released:  <DATE>
 *
...
#include <perfmon_alderlake1_events.h>
#include <perfmon_alderlake1_counters.h>

static int perfmon_numCountersAlderLake1 = NUM_COUNTERS_ALDERLAKE1;
static int perfmon_numCoreCountersAlderLake1 = NUM_COUNTERS_CORE_ALDERLAKE1;
static int perfmon_numUncoreCountersAlderLake1 = NUM_COUNTERS_UNCORE_ALDERLAKE1;
static int perfmon_numArchEventsAlderLake1 = NUM_ARCH_EVENTS_ALDERLAKE1;

int perfmon_init_alderlake1(int cpu_id)
{
    int ret = 0;
...
uint32_t adl1_fixed_setup(int cpu_id, RegisterIndex index, PerfmonEvent *event)
{
    (void)cpu_id;
...
int adl1_pmc_setup(int cpu_id, RegisterIndex index, PerfmonEvent *event)
{
...
int perfmon_setupCounterThread_alderlake1(
        int thread_id,
        PerfmonEventSet* eventSet)
{
    ...
    for (int i=0;i < eventSet->numberOfEvents;i++)
    {
        ...
        {
            case PMC:
                adl1_pmc_setup(cpu_id, index, event);
                break;

            case FIXED:
                fixed_flags |= adl1_fixed_setup(cpu_id, index, event);
                break;
...
int perfmon_startCountersThread_alderlake1(int thread_id, PerfmonEventSet* eventSet)
{
    int haveLock = 0;
    uint64_t flags = 0x0ULL;
...
int perfmon_stopCountersThread_alderlake1(int thread_id, PerfmonEventSet* eventSet)
{
    int haveLock = 0;
...
int perfmon_readCountersThread_alderlake1(int thread_id, PerfmonEventSet* eventSet)
{
    uint64_t flags = 0x0ULL;
    uint64_t uflags = 0x0ULL;
    int haveLock = 0;
...
int perfmon_finalizeCountersThread_alderlake1(int thread_id, PerfmonEventSet* eventSet)
{
    int haveLock = 0;
    int clearPBS = 0;
