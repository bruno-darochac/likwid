 ...
 * =======================================================================================
 *
 *      Filename:  perfmon_alderlake3.h
 *
 *      Description:  Header File of perfmon module for Intel alderlake3.
 *
 *      Version:   <VERSION>
 *      Released:  <DATE>
 *
...
#include <perfmon_alderlake3_events.h>
#include <perfmon_alderlake3_counters.h>

static int perfmon_numCountersAlderLake3 = NUM_COUNTERS_ALDERLAKE3;
static int perfmon_numCoreCountersAlderLake3 = NUM_COUNTERS_CORE_ALDERLAKE3;
static int perfmon_numUncoreCountersAlderLake3 = NUM_COUNTERS_UNCORE_ALDERLAKE3;
static int perfmon_numArchEventsAlderLake3 = NUM_ARCH_EVENTS_ALDERLAKE3;

int perfmon_init_alderlake3(int cpu_id)
{
    int ret = 0;
...
uint32_t adl3_fixed_setup(int cpu_id, RegisterIndex index, PerfmonEvent *event)
{
    (void)cpu_id;
...
int adl3_pmc_setup(int cpu_id, RegisterIndex index, PerfmonEvent *event)
{
...
int perfmon_setupCounterThread_alderlake3(
        int thread_id,
        PerfmonEventSet* eventSet)
{
    ...
    for (int i=0;i < eventSet->numberOfEvents;i++)
    {
        ...
        {
            case PMC:
                adl3_pmc_setup(cpu_id, index, event);
                break;

            case FIXED:
                fixed_flags |= adl3_fixed_setup(cpu_id, index, event);
                break;
...
int perfmon_startCountersThread_alderlake3(int thread_id, PerfmonEventSet* eventSet)
{
    int haveLock = 0;
    uint64_t flags = 0x0ULL;
...
int perfmon_stopCountersThread_alderlake3(int thread_id, PerfmonEventSet* eventSet)
{
    int haveLock = 0;
...
int perfmon_readCountersThread_alderlake3(int thread_id, PerfmonEventSet* eventSet)
{
    uint64_t flags = 0x0ULL;
    uint64_t uflags = 0x0ULL;
    int haveLock = 0;
...
int perfmon_finalizeCountersThread_alderlake3(int thread_id, PerfmonEventSet* eventSet)
{
    int haveLock = 0;
    int clearPBS = 0;
